...
$sql="SELECT * FROM clienti WHERE id_cliente='$_GET[id_cliente]'";
$res=mysql_query($sql);
...
$(document).ready(function(){
  $(".tabella_pratiche_container").load("form/clienti/pratiche.php?id_cliente=<?php echo $id_cliente;?>");
  ...
  $('form.cliente').submit(function(e) {
      ...
      $.ajax({
        ...
        success: function (returndata) {
         $("#contenitore").empty().load("form/clienti/clienti.php"); 
        }
      });
  });
...
<div class="tab-content ">
  ...
  <div class="tab-pane active" id="1">
    ...
    <form class="cliente" action="actions/clienti.php">
