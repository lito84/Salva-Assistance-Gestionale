...
<table class="table table-striped table-bordered">
	...
	<?php 
        ...
        if($_GET["codice_attivazione"]!="") $sql.="AND pratiche.codice_attivazione LIKE '%$_GET[codice_attivazione]%' ";
        if($_GET["prodotto"]!="") $sql.="AND prodotti.prodotto LIKE '%$_GET[prodotto]%' ";
        if($_GET["agente"]!="") $sql.="AND utenti.nome LIKE '%$_GET[agente]%' ";
        if($_GET["cliente"]!="") $sql.="AND clienti.cognome LIKE '%$_GET[agente]%' ";
