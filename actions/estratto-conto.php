...
if($_POST["action"]=="crea_pratica"){
	...
	$sql2="INSERT INTO pratiche (id_cliente, id_invitante, id_prodotto_convenzione, data_inserimento, data_scadenza, data_attivazione, tipo_pagamento, pagato, attivo, user_agent, importo, copertura, validita, id_agente) VALUES ('$id','$id_invitante','$id_convenzione_prodotto', '".date("Y-m-d H:i", strtotime("now"))."','$data_scadenza','".date("Y-m-d H:i", strtotime("now"))."','".addslashes($pagamento)."','$pagato','0','".$_SERVER['HTTP_USER_AGENT']."','$prezzo','$validita','$copertura','$id_utente')";
